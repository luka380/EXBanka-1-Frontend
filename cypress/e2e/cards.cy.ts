describe('Celina 6: Kartice — Upravljanje bankarskim karticama', () => {
  describe('Client: Card Request & Viewing (Scenarios 28–30, 32)', () => {
    beforeEach(() => {
      cy.intercept('GET', '**/api/v3/me/cards', { fixture: 'cards-list.json' }).as('getCards')
    ...
    it('should request a new card for a personal account (Scenario 28)', () => {
      cy.intercept('POST', '**/api/v3/me/cards/requests', {
        statusCode: 201,
        body: {
          id: 5,
    ...
    it('should temporarily block an active card for 12 hours (Scenario 30)', () => {
      cy.intercept('POST', '**/api/v3/me/cards/10/temporary-block', {
        statusCode: 200,
        body: {},
      }).as('blockCard')
      ...
      cy.intercept('GET', '**/api/v3/me/cards', {
        body: {
          cards: [
            {
              id: 10,
  ...
  describe('Employee: Card Management (Scenarios 27, 31)', () => {
    ...
    it('should unblock a blocked card from admin panel (Scenario 31)', () => {
      cy.intercept('GET', '**/api/v3/accounts/1', { fixture: 'admin-account.json' }).as('getAccount')
      cy.intercept('GET', '**/api/v3/accounts/1/cards', {
        fixture: 'admin-cards.json',
      }).as('getAccountCards')
      cy.intercept('POST', '**/api/v3/cards/11/unblock', {
        statusCode: 200,
        body: {},
      }).as('unblockCard')
