describe('Stock Detail Page', () => {
  beforeEach(() => {
    ...
    cy.intercept('GET', '**/api/v3/securities/options*', { fixture: 'stock-options.json' }).as(
      'getOptions'
    )
  })
  ...
  it('should show not found for invalid stock id', () => {
    cy.intercept('GET', '**/api/v3/securities/stocks/999', { statusCode: 200, body: null }).as(
      'getStockNotFound'
    )
    cy.intercept('GET', '**/api/v3/securities/stocks/999/history*', {
