...
describe('getInterestRateTiers', () => {
  it('GET /api/interest-rate-tiers returns tiers', async () => {
    ...
    expect(mockGet).toHaveBeenCalledWith('/interest-rate-tiers')
...
describe('createTier', () => {
  it('POST /api/interest-rate-tiers creates a tier', async () => {
    ...
    expect(mockPost).toHaveBeenCalledWith('/interest-rate-tiers', payload)
...
describe('updateTier', () => {
  it('PUT /api/interest-rate-tiers/:id updates a tier', async () => {
    ...
    expect(mockPut).toHaveBeenCalledWith('/interest-rate-tiers/1', payload)
...
describe('deleteTier', () => {
  it('DELETE /api/interest-rate-tiers/:id deletes a tier', async () => {
    ...
    expect(mockDelete).toHaveBeenCalledWith('/interest-rate-tiers/1')
  })
})
...
describe('applyTier', () => {
  it('POST /api/interest-rate-tiers/:id/apply applies variable rate update', async () => {
    ...
    expect(mockPost).toHaveBeenCalledWith('/interest-rate-tiers/1/apply')
